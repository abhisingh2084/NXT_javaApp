...
@Metadata(
   ...
   d2 = {"Lcom/example/chatapp/MassageAdapter;", "Landroidx/recyclerview/widget/RecyclerView$Adapter;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "context", "Landroid/content/Context;", "messageList", "Ljava/util/ArrayList;", "Lcom/example/chatapp/Message;", "Lkotlin/collections/ArrayList;", "(Landroid/content/Context;Ljava/util/ArrayList;)V", "ITEM_RECEIVE", "", "getITEM_RECEIVE", "()I", "ITEM_SENT", "getITEM_SENT", "getContext", "()Landroid/content/Context;", "getMessageList", "()Ljava/util/ArrayList;", "getItemCount", "getItemViewType", "position", "onBindViewHolder", "", "holder", "onCreateViewHolder", "parent", "Landroid/view/ViewGroup;", "viewType", "ReceiveViewHolder", "SentViewHolder", "ChatApp.app.main"}
)
